...
class TheMatrix
{
 ...
 friend ostream&   operator<< (ostream& os, const TheMatrix& myMatrix);
...
int main()
{
	...
	cout << A; // call the function operator<< to print matrix A
	cout << B; // call the function operator<< to print matrix B
	cout << AddAB; // call the function operator<< to print matrix AddAB
	cout << SubAB; // call the function operator<< to print matrix SubAB
	cout << MulAB; // call the function operator<< to print matrix MulAB
	cout << DivAB; // call the function operator<< to print matrix DivAB
